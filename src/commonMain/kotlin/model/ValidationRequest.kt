...
expect class ValidationRequest() {
    ...
    fun getValidationEngineSettings(): ValidationEngineSettings
    fun setValidationEngineSettings(validationEngineSettings: ValidationEngineSettings): ValidationRequest
